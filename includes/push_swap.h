...
/*   Updated: 2018/07/13 18:39:05 by blee             ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef void		(*t_swapf)(t_num**, t_num**);
...
void				quick_sort_a(t_num **lst_a, t_num **lst_b,
		int min, int max);
void				quick_sort_b(t_num **lst_a, t_num **lst_b,
		int min, int max);
